...
def run_evaluation_pipeline(test_data_path, output_path="output1.json"):
    ...
    for idx, item in enumerate(test_data):
        ...
        pred_fact, pred_conf, raw_votes , raw_outputs= infer_with_consistency(item, n_votes=1) 
        ...
        output_item['output'] = raw_outputs
